                        ...
                        <form class="row">
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="col d-flex justify-content-end align-items-center">
                                    ...
                                    <!-- Back button end -->
                                    <!-- Next button start -->
                                    <button onclick="location.href='forgot-password-complete.php'" type="button" class="btn btn-lg custom-btn-noanim d-flex align-items-center justify-content-between">
