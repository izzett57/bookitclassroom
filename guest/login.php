            ...
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    ...
                    <a class="me-3" href="#" role="button">
                        <button onclick="history.back()" type="button" class="btn btn-light btn-circle">
                ...
                <div class="col d-flex flex-column">
                    ...
                    <!-- Sign in form start -->
                        <form class="row">
                            ...
                            <div>
                            <a class="inter-regular" href="#" style="text-decoration: none; font-size: 0.9rem; color: rgba(218, 116, 34, 0.75);">Forgot your password?</a>
                            </div>
                            <!-- Forgot password end -->
                            <div class="row pt-4">
                                <!-- Spacing start -->
                                ...
                                <div class="col d-flex justify-content-end align-items-center">
                                    ...
                                    <a class="dongle-regular custom-btn-inline me-3 mt-2 primary" href="#" style="text-decoration: none; font-size: 2rem">register</a>
                                    <!-- Register button end -->
                                    <!-- Login button start -->
