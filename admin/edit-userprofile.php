        ...
        <div class="container main-content bg-white rounded-3 d-flex flex-column justify-content-center">
            <div class="container">
                ...
                <div class="d-flex justify-content-end">
                    <a href="edit-users.php" class="dongle-regular custom-btn-inline me-3 mt-2 primary" style="text-decoration: none; font-size: 2rem; cursor: pointer;">cancel</a>
                </div>
                <div class="col d-flex justify-content-center align-items-center">
                    ...
                    <form class="container" method="POST" action="edit-userprofile.php?id=<?php echo $user_id; ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="pt-3">
                                <label class="form-label inter-regular" for="occupation" style="letter-spacing: 4px; color: #272937; text-transform: uppercase;">Occupation</label><br>
                                <select class="form-select" id="occupation" name="occupation">
                                    <option value="ADMIN" <?php echo $user['User_Type'] == 'ADMIN' ? 'selected' : ''; ?>>Admin</option>
                                    <option value="LECTURER" <?php echo $user['User_Type'] == 'LECTURER' ? 'selected' : ''; ?>>Lecturer</option>
                                    <option value="CLUB_LEAD" <?php echo $user['User_Type'] == 'CLUB_LEADER' ? 'selected' : ''; ?>>Student Club Leader</option>
