        ...
        <div class="container main-content bg-white rounded-3 d-flex flex-column justify-content-center">
            <div class="container">
                ...
                <div class="d-flex justify-content-end">
                    <a onclick="location.href='edit-users.php'" class="dongle-regular custom-btn-inline me-3 mt-2 primary" style="text-decoration: none; font-size: 2rem; cursor: pointer;">cancel</a>
                </div>
                <!-- Cancel button end -->
                <!-- Profile start -->
                <div class="col d-flex justify-content-center align-items-center">
                    ...
                    <div class="container d-flex justify-content-center text-center py-3">
                        <div class="row d-flex justify-content-center">
                            ...
                            <a onclick="location.href='#'" class="dongle-regular custom-btn-inline mt-2 primary" href="#" style="text-decoration: none; font-size: 2rem">edit</a>
                        </div>
                    </div>
                    <!-- Picture end -->
                    <!-- Data field start -->
